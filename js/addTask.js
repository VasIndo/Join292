 ...
 */
/**
 * Fügt eine neue Aufgabe hinzu, zeigt eine Erfolgsbenachrichtigung und leitet zur Board-Seite weiter.
 */
async function pushNewTaskInJson() {
    if (checkEmptyFields()) {
      ...
      // Nach 2 Sekunden zur Board-Seite weiterleiten
      setTimeout(() => {
        window.location.href = "board.html"; // Pfad zur Board-Seite
      }, 2000);
    }
  }
  
  /**
   * Zeigt eine Erfolgsbenachrichtigung an, dass die Aufgabe hinzugefügt wurde.
   */
